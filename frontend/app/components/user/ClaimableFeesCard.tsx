...
export function TotalFeesCard({ totalClaimable, totalEarned, tokenCount }: TotalFeesCardProps) {
  ...
  const showEarned = totalEarned !== undefined;
    ...
    >
      ...
      <div className={`grid ${showEarned ? 'grid-cols-3' : 'grid-cols-2'} gap-3`}>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-text-muted">Active Tokens</p>
        </div>
      </div>
    </motion.div>
  );
